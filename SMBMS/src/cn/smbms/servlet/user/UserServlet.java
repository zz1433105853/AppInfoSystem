...
public class UserServlet extends HttpServlet {
	...
	private void updatePwd(HttpServletRequest request, HttpServletResponse response)
		...
		if(o != null && !StringUtils.isNullOrEmpty(newpassword)){
			UserServce userService = new UserServiceImpl();
			flag = (userService.updatePwd(((User)o).getId(),newpassword))>0;
			if(flag){
	...
	private void query(HttpServletRequest request, HttpServletResponse response)
    	...
    	//总数量（表）	
    	int totalCount	= userService.getUserList(queryUserName,queryUserRole).size();
    	//总页数
		...
		userList = userService.getUselistP(queryUserName,queryUserRole,currentPageNo, pageSize);
