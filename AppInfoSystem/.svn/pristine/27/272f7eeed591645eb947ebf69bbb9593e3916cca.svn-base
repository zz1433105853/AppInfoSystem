		...
		<div class="x_panel">
			...
			<div class="x_content">
			    ...
			    <ul>
					...
					<li>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">一级分类${queryCategoryLevel1 }</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
					...
					<li>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">二级分类${queryCategoryLevel2 }</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
					...
					<li>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">三级分类${queryCategoryLevel3 }</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
